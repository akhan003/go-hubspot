...
// checks if the CollectionResponsePublicAuditInfoNoPaging type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionResponsePublicAuditInfoNoPaging{}
...
type _CollectionResponsePublicAuditInfoNoPaging CollectionResponsePublicAuditInfoNoPaging
...
func (o CollectionResponsePublicAuditInfoNoPaging) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["results"] = o.Results
	return toSerialize, nil
}

func (o *CollectionResponsePublicAuditInfoNoPaging) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionResponsePublicAuditInfoNoPaging := _CollectionResponsePublicAuditInfoNoPaging{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionResponsePublicAuditInfoNoPaging)

	if err != nil {
		return err
	}

	*o = CollectionResponsePublicAuditInfoNoPaging(varCollectionResponsePublicAuditInfoNoPaging)
