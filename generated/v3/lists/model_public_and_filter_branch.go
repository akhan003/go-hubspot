...
// checks if the PublicAndFilterBranch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicAndFilterBranch{}

// PublicAndFilterBranch struct for PublicAndFilterBranch
...
type _PublicAndFilterBranch PublicAndFilterBranch
...
func NewPublicAndFilterBranchWithDefaults() *PublicAndFilterBranch {
	this := PublicAndFilterBranch{}
	var filterBranchType string = "AND"
	this.FilterBranchType = filterBranchType
	return &this
}
...
func (o PublicAndFilterBranch) MarshalJSON() ([]byte, error) {
...
func (o PublicAndFilterBranch) ToMap() (map[string]interface{}, error) {
...
func (o *PublicAndFilterBranch) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicAndFilterBranch := _PublicAndFilterBranch{}

	err = json.Unmarshal(data, &varPublicAndFilterBranch)

	if err != nil {
		return err
	}

	*o = PublicAndFilterBranch(varPublicAndFilterBranch)
...
type NullablePublicAndFilterBranch struct {
	value *PublicAndFilterBranch
	isSet bool
}

func (v NullablePublicAndFilterBranch) Get() *PublicAndFilterBranch {
	return v.value
}

func (v *NullablePublicAndFilterBranch) Set(val *PublicAndFilterBranch) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicAndFilterBranch) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicAndFilterBranch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicAndFilterBranch(val *PublicAndFilterBranch) *NullablePublicAndFilterBranch {
	return &NullablePublicAndFilterBranch{value: val, isSet: true}
}

func (v NullablePublicAndFilterBranch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicAndFilterBranch) UnmarshalJSON(src []byte) error {
	v.isSet = true
