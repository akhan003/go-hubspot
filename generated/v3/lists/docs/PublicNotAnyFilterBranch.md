...
`func NewPublicNotAnyFilterBranch(filterBranchType string, filterBranchOperator string, filterBranches []PublicPropertyAssociationFilterBranchFilterBranchesInner, filters []PublicPropertyAssociationFilterBranchFiltersInner, ) *PublicNotAnyFilterBranch`
