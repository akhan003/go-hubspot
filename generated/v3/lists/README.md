...
*MembershipsAPI* | [**Add**](docs/MembershipsAPI.md#add) | **Put** /crm/v3/lists/{listId}/memberships/add | Add Records to a List
...
*MembershipsAPI* | [**AddAndRemove**](docs/MembershipsAPI.md#addandremove) | **Put** /crm/v3/lists/{listId}/memberships/add-and-remove | Add and/or Remove Records from a List
...
*MembershipsAPI* | [**Remove**](docs/MembershipsAPI.md#remove) | **Put** /crm/v3/lists/{listId}/memberships/remove | Remove Records from a List
