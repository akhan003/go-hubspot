...
// PublicEventAnalyticsFilterCoalescingRefineBy - struct for PublicEventAnalyticsFilterCoalescingRefineBy
type PublicEventAnalyticsFilterCoalescingRefineBy struct {
...
// PublicAbsoluteComparativeTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicAbsoluteComparativeTimestampRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicAbsoluteComparativeTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicAbsoluteComparativeTimestampRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicAbsoluteComparativeTimestampRefineBy: v,
	}
}

// PublicAbsoluteRangedTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicAbsoluteRangedTimestampRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicAbsoluteRangedTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicAbsoluteRangedTimestampRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicAbsoluteRangedTimestampRefineBy: v,
	}
}

// PublicAllHistoryRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicAllHistoryRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicAllHistoryRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicAllHistoryRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicAllHistoryRefineBy: v,
	}
}

// PublicNumOccurrencesRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicNumOccurrencesRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicNumOccurrencesRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicNumOccurrencesRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicNumOccurrencesRefineBy: v,
	}
}

// PublicRangedTimeOperationAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicRangedTimeOperation wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicRangedTimeOperationAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicRangedTimeOperation) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicRangedTimeOperation: v,
	}
}

// PublicRelativeComparativeTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicRelativeComparativeTimestampRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicRelativeComparativeTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicRelativeComparativeTimestampRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicRelativeComparativeTimestampRefineBy: v,
	}
}

// PublicRelativeRangedTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicRelativeRangedTimestampRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicRelativeRangedTimestampRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicRelativeRangedTimestampRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicRelativeRangedTimestampRefineBy: v,
	}
}

// PublicSetOccurrencesRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicSetOccurrencesRefineBy wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicSetOccurrencesRefineByAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicSetOccurrencesRefineBy) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
		PublicSetOccurrencesRefineBy: v,
	}
}

// PublicTimePointOperationAsPublicEventAnalyticsFilterCoalescingRefineBy is a convenience function that returns PublicTimePointOperation wrapped in PublicEventAnalyticsFilterCoalescingRefineBy
func PublicTimePointOperationAsPublicEventAnalyticsFilterCoalescingRefineBy(v *PublicTimePointOperation) PublicEventAnalyticsFilterCoalescingRefineBy {
	return PublicEventAnalyticsFilterCoalescingRefineBy{
...
func (dst *PublicEventAnalyticsFilterCoalescingRefineBy) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(PublicEventAnalyticsFilterCoalescingRefineBy)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(PublicEventAnalyticsFilterCoalescingRefineBy)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src PublicEventAnalyticsFilterCoalescingRefineBy) MarshalJSON() ([]byte, error) {
...
func (obj *PublicEventAnalyticsFilterCoalescingRefineBy) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
...
type NullablePublicEventAnalyticsFilterCoalescingRefineBy struct {
	value *PublicEventAnalyticsFilterCoalescingRefineBy
	isSet bool
}

func (v NullablePublicEventAnalyticsFilterCoalescingRefineBy) Get() *PublicEventAnalyticsFilterCoalescingRefineBy {
	return v.value
}

func (v *NullablePublicEventAnalyticsFilterCoalescingRefineBy) Set(val *PublicEventAnalyticsFilterCoalescingRefineBy) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicEventAnalyticsFilterCoalescingRefineBy) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicEventAnalyticsFilterCoalescingRefineBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicEventAnalyticsFilterCoalescingRefineBy(val *PublicEventAnalyticsFilterCoalescingRefineBy) *NullablePublicEventAnalyticsFilterCoalescingRefineBy {
	return &NullablePublicEventAnalyticsFilterCoalescingRefineBy{value: val, isSet: true}
}

func (v NullablePublicEventAnalyticsFilterCoalescingRefineBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicEventAnalyticsFilterCoalescingRefineBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
