...
type _IntegratorCardPayloadResponse IntegratorCardPayloadResponse
...
func (o *IntegratorCardPayloadResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegratorCardPayloadResponse := _IntegratorCardPayloadResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIntegratorCardPayloadResponse)

	if err != nil {
		return err
	}

	*o = IntegratorCardPayloadResponse(varIntegratorCardPayloadResponse)
