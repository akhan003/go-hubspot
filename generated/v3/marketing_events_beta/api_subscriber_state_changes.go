...
func (r ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsertRequest) Execute() (*Error, *http.Response, error) {
...
*/
func (a *SubscriberStateChangesAPIService) PostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsert(ctx context.Context, externalEventId string, subscriberState string) ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsertRequest {
	return ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsertRequest{
		ApiService:      a,
		ctx:             ctx,
...
//
//	@return Error
func (a *SubscriberStateChangesAPIService) PostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsertExecute(r ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateEmailUpsertRequest) (*Error, *http.Response, error) {
	var (
...
func (r ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsertRequest) Execute() (*Error, *http.Response, error) {
...
*/
func (a *SubscriberStateChangesAPIService) PostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsert(ctx context.Context, externalEventId string, subscriberState string) ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsertRequest {
	return ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsertRequest{
		ApiService:      a,
		ctx:             ctx,
		externalEventId: externalEventId,
...
//
//	@return Error
func (a *SubscriberStateChangesAPIService) PostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsertExecute(r ApiPostMarketingV3MarketingEventsEventsExternalEventIdSubscriberStateUpsertRequest) (*Error, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
