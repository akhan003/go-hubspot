...
func (r ApiGetMarketingV3MarketingEventsAppIdSettingsRequest) Execute() (*EventDetailSettings, *http.Response, error) {
...
*/
func (a *SettingsAPIService) GetMarketingV3MarketingEventsAppIdSettings(ctx context.Context, appId int32) ApiGetMarketingV3MarketingEventsAppIdSettingsRequest {
	return ApiGetMarketingV3MarketingEventsAppIdSettingsRequest{
		ApiService: a,
		ctx:        ctx,
		appId:      appId,
...
func (a *SettingsAPIService) GetMarketingV3MarketingEventsAppIdSettingsExecute(r ApiGetMarketingV3MarketingEventsAppIdSettingsRequest) (*EventDetailSettings, *http.Response, error) {
	var (
...
func (r ApiPostMarketingV3MarketingEventsAppIdSettingsRequest) Execute() (*EventDetailSettings, *http.Response, error) {
...
*/
func (a *SettingsAPIService) PostMarketingV3MarketingEventsAppIdSettings(ctx context.Context, appId int32) ApiPostMarketingV3MarketingEventsAppIdSettingsRequest {
	return ApiPostMarketingV3MarketingEventsAppIdSettingsRequest{
		ApiService: a,
		ctx:        ctx,
		appId:      appId,
...
//
//	@return EventDetailSettings
func (a *SettingsAPIService) PostMarketingV3MarketingEventsAppIdSettingsExecute(r ApiPostMarketingV3MarketingEventsAppIdSettingsRequest) (*EventDetailSettings, *http.Response, error) {
	var (
