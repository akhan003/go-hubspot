...
type _PublicAssociation PublicAssociation
...
func (o *PublicAssociation) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicAssociation := _PublicAssociation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicAssociation)

	if err != nil {
		return err
	}

	*o = PublicAssociation(varPublicAssociation)
