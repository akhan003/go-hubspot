...
// checks if the BatchResponsePublicAssociationMultiWithErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponsePublicAssociationMultiWithErrors{}
...
type _BatchResponsePublicAssociationMultiWithErrors BatchResponsePublicAssociationMultiWithErrors
...
func (o BatchResponsePublicAssociationMultiWithErrors) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponsePublicAssociationMultiWithErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponsePublicAssociationMultiWithErrors := _BatchResponsePublicAssociationMultiWithErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponsePublicAssociationMultiWithErrors)

	if err != nil {
		return err
	}

	*o = BatchResponsePublicAssociationMultiWithErrors(varBatchResponsePublicAssociationMultiWithErrors)
