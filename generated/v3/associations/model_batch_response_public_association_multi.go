...
// checks if the BatchResponsePublicAssociationMulti type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponsePublicAssociationMulti{}
...
type _BatchResponsePublicAssociationMulti BatchResponsePublicAssociationMulti
...
func (o BatchResponsePublicAssociationMulti) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponsePublicAssociationMulti) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponsePublicAssociationMulti := _BatchResponsePublicAssociationMulti{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponsePublicAssociationMulti)

	if err != nil {
		return err
	}

	*o = BatchResponsePublicAssociationMulti(varBatchResponsePublicAssociationMulti)
