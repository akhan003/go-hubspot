...
type _PublicAssociationMulti PublicAssociationMulti
...
func (o *PublicAssociationMulti) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicAssociationMulti := _PublicAssociationMulti{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicAssociationMulti)

	if err != nil {
		return err
	}

	*o = PublicAssociationMulti(varPublicAssociationMulti)
