...
type _PublicImportMetadata PublicImportMetadata
...
func (o *PublicImportMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicImportMetadata := _PublicImportMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicImportMetadata)

	if err != nil {
		return err
	}

	*o = PublicImportMetadata(varPublicImportMetadata)
