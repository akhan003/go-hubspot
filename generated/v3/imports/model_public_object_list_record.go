...
type _PublicObjectListRecord PublicObjectListRecord
...
func (o *PublicObjectListRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicObjectListRecord := _PublicObjectListRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicObjectListRecord)

	if err != nil {
		return err
	}

	*o = PublicObjectListRecord(varPublicObjectListRecord)
