...
type _ObjectSyncFeature ObjectSyncFeature
...
func (o *ObjectSyncFeature) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectSyncFeature := _ObjectSyncFeature{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectSyncFeature)

	if err != nil {
		return err
	}

	*o = ObjectSyncFeature(varObjectSyncFeature)
