...
// checks if the SyncContactsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncContactsRequest{}
...
type _SyncContactsRequest SyncContactsRequest
...
func (o SyncContactsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SyncContactsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSyncContactsRequest := _SyncContactsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSyncContactsRequest)

	if err != nil {
		return err
	}

	*o = SyncContactsRequest(varSyncContactsRequest)
