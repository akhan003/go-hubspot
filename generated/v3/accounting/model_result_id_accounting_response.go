...
type _ResultIdAccountingResponse ResultIdAccountingResponse
...
func (o *ResultIdAccountingResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResultIdAccountingResponse := _ResultIdAccountingResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultIdAccountingResponse)

	if err != nil {
		return err
	}

	*o = ResultIdAccountingResponse(varResultIdAccountingResponse)
