...
type _AccountingFeatures AccountingFeatures
...
func (o *AccountingFeatures) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountingFeatures := _AccountingFeatures{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountingFeatures)

	if err != nil {
		return err
	}

	*o = AccountingFeatures(varAccountingFeatures)
