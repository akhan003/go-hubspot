...
type _InvoiceReadResponse InvoiceReadResponse
...
func (o *InvoiceReadResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoiceReadResponse := _InvoiceReadResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvoiceReadResponse)

	if err != nil {
		return err
	}

	*o = InvoiceReadResponse(varInvoiceReadResponse)
