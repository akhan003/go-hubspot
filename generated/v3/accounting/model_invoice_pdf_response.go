...
type _InvoicePdfResponse InvoicePdfResponse
...
func (o *InvoicePdfResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoicePdfResponse := _InvoicePdfResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvoicePdfResponse)

	if err != nil {
		return err
	}

	*o = InvoicePdfResponse(varInvoicePdfResponse)
