...
type _AccountingAppSettings AccountingAppSettings
...
func (o *AccountingAppSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountingAppSettings := _AccountingAppSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountingAppSettings)

	if err != nil {
		return err
	}

	*o = AccountingAppSettings(varAccountingAppSettings)
