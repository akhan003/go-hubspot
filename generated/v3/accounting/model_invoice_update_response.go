...
type _InvoiceUpdateResponse InvoiceUpdateResponse
...
func (o *InvoiceUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoiceUpdateResponse := _InvoiceUpdateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvoiceUpdateResponse)

	if err != nil {
		return err
	}

	*o = InvoiceUpdateResponse(varInvoiceUpdateResponse)
