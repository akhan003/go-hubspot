...
type _ExchangeRateResponse ExchangeRateResponse
...
func (o *ExchangeRateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExchangeRateResponse := _ExchangeRateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExchangeRateResponse)

	if err != nil {
		return err
	}

	*o = ExchangeRateResponse(varExchangeRateResponse)
