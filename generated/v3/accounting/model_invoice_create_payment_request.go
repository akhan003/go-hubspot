...
type _InvoiceCreatePaymentRequest InvoiceCreatePaymentRequest
...
func (o *InvoiceCreatePaymentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varInvoiceCreatePaymentRequest := _InvoiceCreatePaymentRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvoiceCreatePaymentRequest)

	if err != nil {
		return err
	}

	*o = InvoiceCreatePaymentRequest(varInvoiceCreatePaymentRequest)
