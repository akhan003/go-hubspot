...
type _AccountingExtensionTerm AccountingExtensionTerm
...
func (o *AccountingExtensionTerm) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountingExtensionTerm := _AccountingExtensionTerm{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountingExtensionTerm)

	if err != nil {
		return err
	}

	*o = AccountingExtensionTerm(varAccountingExtensionTerm)
