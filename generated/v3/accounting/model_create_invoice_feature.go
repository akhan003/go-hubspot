...
type _CreateInvoiceFeature CreateInvoiceFeature
...
func (o *CreateInvoiceFeature) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateInvoiceFeature := _CreateInvoiceFeature{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateInvoiceFeature)

	if err != nil {
		return err
	}

	*o = CreateInvoiceFeature(varCreateInvoiceFeature)
