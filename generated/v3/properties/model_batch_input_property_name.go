...
type _BatchInputPropertyName BatchInputPropertyName
...
func (o *BatchInputPropertyName) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchInputPropertyName := _BatchInputPropertyName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchInputPropertyName)

	if err != nil {
		return err
	}

	*o = BatchInputPropertyName(varBatchInputPropertyName)
