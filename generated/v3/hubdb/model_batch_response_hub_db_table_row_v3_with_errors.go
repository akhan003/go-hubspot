...
// checks if the BatchResponseHubDbTableRowV3WithErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseHubDbTableRowV3WithErrors{}
...
type _BatchResponseHubDbTableRowV3WithErrors BatchResponseHubDbTableRowV3WithErrors
...
func (o BatchResponseHubDbTableRowV3WithErrors) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseHubDbTableRowV3WithErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseHubDbTableRowV3WithErrors := _BatchResponseHubDbTableRowV3WithErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseHubDbTableRowV3WithErrors)

	if err != nil {
		return err
	}

	*o = BatchResponseHubDbTableRowV3WithErrors(varBatchResponseHubDbTableRowV3WithErrors)
