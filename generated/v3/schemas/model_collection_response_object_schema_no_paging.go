...
type _CollectionResponseObjectSchemaNoPaging CollectionResponseObjectSchemaNoPaging
...
func (o *CollectionResponseObjectSchemaNoPaging) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionResponseObjectSchemaNoPaging := _CollectionResponseObjectSchemaNoPaging{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionResponseObjectSchemaNoPaging)

	if err != nil {
		return err
	}

	*o = CollectionResponseObjectSchemaNoPaging(varCollectionResponseObjectSchemaNoPaging)
