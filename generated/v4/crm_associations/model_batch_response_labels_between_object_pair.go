...
// checks if the BatchResponseLabelsBetweenObjectPair type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseLabelsBetweenObjectPair{}
...
type _BatchResponseLabelsBetweenObjectPair BatchResponseLabelsBetweenObjectPair
...
func (o BatchResponseLabelsBetweenObjectPair) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseLabelsBetweenObjectPair) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseLabelsBetweenObjectPair := _BatchResponseLabelsBetweenObjectPair{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseLabelsBetweenObjectPair)

	if err != nil {
		return err
	}

	*o = BatchResponseLabelsBetweenObjectPair(varBatchResponseLabelsBetweenObjectPair)
